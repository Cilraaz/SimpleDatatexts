...
L["Enable Font Text Shadow"] = "글꼴 텍스트 그림자 활성화"
L["Add a subtle shadow to datatexts for better readability"] = "가독성 향상을 위해 데이터텍스트에 은은한 그림자 추가"
L["Enable Tooltip Text Shadow"] = "툴팁 텍스트 그림자 활성화"
L["Add a subtle shadow to tooltip text for better readability"] = "가독성 향상을 위해 툴팁 텍스트에 은은한 그림자 추가"
...
L["Hide All Panels During Combat"] = "전투 중 모든 패널 숨기기"
L["Hide all panels while you are in combat."] = "전투 중에는 모든 패널을 숨깁니다."
...
L["Loot Specialization set to: Current Specialization"] = "전리품 전문화 설정: 현재 전문화"
...
L["MOTD"] = "오늘의 메시지"
L["MOTD Unavailable due to combat lockdown."] = "전투 잠금으로 인해 오늘의 메시지를 사용할 수 없습니다."
