...
L["Enable Font Text Shadow"] = "启用字体文本阴影"
L["Add a subtle shadow to datatexts for better readability"] = "为数据文本添加细微阴影以提高可读性"
L["Enable Tooltip Text Shadow"] = "启用提示框文本阴影"
L["Add a subtle shadow to tooltip text for better readability"] = "为提示框文本添加细微阴影以提高可读性"
L["Tooltip Settings"] = "提示框设置"
L["Tooltip Font"] = "提示框字体"
L["Font used for all addon tooltips"] = "用于所有插件提示框的字体"
L["Tooltip Font Outline"] = "提示框字体描边"
L["Font outline for all addon tooltips"] = "所有插件提示框的字体描边"
...
L["Hide this panel while you are in combat."] = "在战斗中隐藏此面板。"
L["Hide All Panels During Combat"] = "战斗中隐藏所有面板"
L["Hide all panels while you are in combat."] = "在战斗中隐藏所有面板。"
...
L["Show Rested XP Bar"] = "显示休息经验条"
L["Override Default Rested Color"] = "覆盖默认休息颜色"
L["Rested Custom Color"] = "自定义休息颜色"
L["Rested:"] = "休息："
...
L["Show Silver"] = "显示银币"
L["Show Copper"] = "显示铜币"
L["Use Coin Icons"] = "使用货币图标"
L["Display Quantities"] = "显示数量"
L["Characters to Show"] = "显示角色"
L["Servers to Show"] = "显示服务器"
L["Session:"] = "本次登录："
L["Earned:"] = "获得："
L["Spent:"] = "花费："
L["Profit:"] = "盈利："
...
L["Maximum Item Level"] = "最高物品等级"
L["Show Max Item Level"] = "显示最高物品等级"
...
-- ----------------------------
L["Left Click: Change Loot Specialization"] = "左键点击：更改战利品专精"
L["Current"] = "当前"
...
L["Show Loadout"] = "显示配装"
L["Loot Specialization set to: Current Specialization"] = "拾取专精设置为：当前专精"
...
L["MOTD"] = "今日消息"
L["MOTD Unavailable due to combat lockdown."] = "由于战斗锁定，今日消息不可用。"
