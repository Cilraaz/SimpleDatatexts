...
local moduleName = "Class Specialization"
...
function mod.Create(slotFrame)
    ...
    ----------------------------------------------------
    -- Build/refresh spec and loadout lists
    ----------------------------------------------------
    ...
    slotFrame:SetScript("OnEnter", function(self)
        ...
        SDT.FormatUtils:AddTooltipLine(SDT.Tooltip, nil, " ")
        SDT.FormatUtils:AddTooltipLine(SDT.Tooltip, nil, L["Left Click: Change Talent Specialization"])
        SDT.FormatUtils:AddTooltipLine(SDT.Tooltip, nil, L["Control + Left Click: Change Loadout"])
        SDT.FormatUtils:AddTooltipLine(SDT.Tooltip, nil, L["Shift + Left Click: Show Talent Specialization UI"])
